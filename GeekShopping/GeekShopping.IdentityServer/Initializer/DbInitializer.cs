...
namespace GeekShopping.IdentityServer.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public DbInitializer(IdentityServerContext context, UserManager<ApplicationUser> user, RoleManager<IdentityRole> role)
        {
            _context = context;
            _user = user;
            _role = role;
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "leonardo-admin@leo.com.br",
                EmailConfirmed = true,
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "leonardo-client@leo.com.br",
                EmailConfirmed = true,
                PhoneNumber = "+55 (11) 12345-6789",
                FirstName = "Leonardo",
                LastName = "Client"
